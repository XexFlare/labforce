 ...
 where parent_id=$testID and parent_type='test'");
  $lab1 = ['comments' => '', 'location' => '', 'file' => $labPhoto];
  $product = ['comments' => '', 'location' => '', 'file' => $productPhoto];
  $package = ['comments' => '', 'location' => '', 'file' => $packagePhoto];
 ...
 <div class="row">
   <div class="col-md-4">
     <div class="thumbnail">
       ...
       <p><a href="photo_lab_add.php?id=<?php echo "$testID"; ?>&batch=<?php echo "$batchID"; ?>&ref=product">Add Photo 1</a></p>
     </div>
   </div>
   ...
   <div class="col-md-4">
     <div class="thumbnail">
       ...
       <p><a href="photo_lab_add.php?id=<?php echo "$testID"; ?>&batch=<?php echo "$batchID"; ?>&ref=package"> Add Photo 2</a></p>
     </div>
   ...
   <div class="col-md-4">
     <div class="thumbnail">
       ...
       <p><a href="photo_lab_add.php?id=<?php echo "$testID"; ?>&batch=<?php echo "$batchID"; ?>&ref=lab1">Add Photo 3</a></p>
     </div>
   </div>
   <div class="col-md-4">
     <div class="thumbnail">
       ...
       <p><a href="photo_lab_add.php?id=<?php echo "$testID"; ?>&batch=<?php echo "$batchID"; ?>&ref=lab2">Add Photo 4</a></p>
     </div>
   </div>
   <div class="col-md-4">
     <div class="thumbnail">
       ...
       <p><a href="photo_lab_add.php?id=<?php echo "$testID"; ?>&batch=<?php echo "$batchID"; ?>&ref=lab3">Add Photo 5</a></p>
     </div>
   </div>
   <div class="col-md-4">
     <div class="rounded bg-light h-50 p-5 w-50">
       <p><a href="photo_lab_add.php?id=<?php echo "$testID"; ?>&batch=<?php echo "$batchID"; ?>&ref=gallery"><i class="fa fa-plus" style="font-size: 50px;"></i></a></p>
