  ...
  <div class="page-content-wrapper">
    <div id="content" class="page-content">
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="white-box">
          <h4>SAMPLE No: <b class="text-primary">
                <?php 
            ...
            <?php } if (!isset($exec_action) && !isset($action)) { ?>
            ...
            <?php include('includes/analysis.php'); ?>
            <hr>
            <?php if(isset($action)) { ?>
                  ...
                  <div class="container-fluid">
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-10" style="background-color:lavenderblush;">
                        ...
                        <?php } if(isset($exec_remarks) && $exec_remarks != '') { ?>
                          <p><b>QA REMARKS:</b> <?php echo $exec_remarks; ?></p>
                        <?php } if (isset($qa_fname) && $qa_fname != '') { ?>
